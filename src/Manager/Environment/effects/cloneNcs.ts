...
export const cloneNcs =
    ...
    async (dispatch: Dispatch) => {
        if (isLegacyEnvironment(version)) {
            await legacyCloneNcs(dispatch, version, justUpdate, toolchainDir);
        } else {
            await nrfUtilCloneNcs(dispatch, version, justUpdate, toolchainDir);
        }
    };

async function legacyCloneNcs(
    dispatch: Dispatch,
    version: string,
    justUpdate: boolean,
    toolchainDir: string
...
async function nrfUtilCloneNcs(
    dispatch: Dispatch,
    version: string,
    justUpdate: boolean,
    toolchainDir: string
